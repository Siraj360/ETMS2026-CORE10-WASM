!function() {
    ...
    function N(e, t, n) {
        return k(e, t.eventHandlerId, ( () => R(e).invokeMethodAsync("DispatchEventAsync", t, n)))
    }
    function R(e) {
        const t = S.get(e);
        if (!t)
    ...
    let k = (e, t, n) => n();
    const D = x(["abort", "blur", "cancel", "canplay", "canplaythrough", "change", "close", "cuechange", "durationchange", "emptied", "ended", "error", "focus", "load", "loadeddata", "loadedmetadata", "loadend", "loadstart", "mouseenter", "mouseleave", "pointerenter", "pointerleave", "pause", "play", "playing", "progress", "ratechange", "reset", "scroll", "seeked", "seeking", "stalled", "submit", "suspend", "timeupdate", "toggle", "unload", "volumechange", "waiting", "DOMNodeInsertedIntoDocument", "DOMNodeRemovedFromDocument"])
      , _ = {
        submit: !0
    }
        ...
        dispatchGlobalEventToAllElements(e, t) {
            ...
            for (; r; ) {
                ...
                if (m) {
                    ...
                    if (n && (u = f,
                    d = t.type,
                    !((u instanceof HTMLButtonElement || u instanceof HTMLInputElement || u instanceof HTMLTextAreaElement || u instanceof HTMLSelectElement) && Object.prototype.hasOwnProperty.call(O, d) && u.disabled))) {
                        if (!s) {
                            const n = c(e);
    ...
    e.attachReviver(( (e, t) => t && "object" == typeof t && Object.prototype.hasOwnProperty.call(t, te) && "string" == typeof t[te] ? function(e) {
        const t = `[${ee(e)}]`;
    ...
    class fe {
        ...
        updateComponent(e, t, n, r) {
            ...
            le.delete(o) && (this.detachEventHandlersFromElement(o),
            j(o),
        ...
        insertElement(e, t, n, o, i, s, a) {
            const c = e.frameReader
              , l = c.elementName(s)
              , u = "svg" === l || V(n) ? document.createElementNS("http://www.w3.org/2000/svg", l) : document.createElement(l)
              , d = H(u);
            let f = !1;
            ...
            (function(e, t, n) {
                ...
                case "value":
                    return function(e, t) {
                        ...
                        case "SELECT":
                        case "TEXTAREA":
                            return t && e instanceof HTMLSelectElement && re(e) && (t = JSON.parse(t)),
                            ie(e, t),
                            e[ne] = t,
                            !0;
                        case "OPTION":
    ...
    function Le(e, t, n=!1) {
        const r = Ce(e);
        !t.forceLoad && Ee(r) ? Fe(r, !1, t.replaceHistoryEntry, t.historyEntryState, n) : function(e, t) {
            if (location.href === e) {
                const t = e + "?";
    ...
    async function Fe(e, t, n, r=void 0, o=!1) {
        ...
        const i = Je();
        (o || !i?.hasLocationChangingEventListeners || await Be(e, r, t, i)) && (function(e, t) {
            const n = new URL(e)
              , r = new URL(t);
    ...
    function Be(e, t, n, r) {
        return new Promise((o => {
            ...
            ke++,
            Oe = o,
            r.locationChanging(ke, e, t, n)
        }
        ))
    }
    async function He(e, t) {
        const n = location.href;
        await Promise.all(Array.from(De, (async ([t,r]) => {
    ...
    const ze = {
      ...
      , We = Symbol();
    function Ue(e) {
        return e && e !== document.body && e !== document.documentElement ? "visible" !== getComputedStyle(e).overflowY ? e : Ue(e.parentElement) : null
    }
    function Ve(e) {
    ...
    const tt = navigator
      ...
      , rt = nt && nt.length > 0 ? nt.some((e => "Google Chrome" === e.brand || "Microsoft Edge" === e.brand || "Chromium" === e.brand)) : window.chrome
      , ot = tt.userAgentData?.platform ?? navigator.platform;
    function it(e) {
        return 0 !== e.debugLevel && (rt || navigator.userAgent.includes("Firefox"))
    }
    let st = !1;
    function at() {
            ...
            await Promise.all(e.map((e => async function(e, n) {
                ...
                if (void 0 !== i) {
                    if (e.singleRuntime) {
                        ...
                        let d = r;
                        return e.webRendererId === ct.Server && l && (d = l),
                    ...
                    return function(e, t, n) {
                        ...
                        if (h && !o.enableClassicInitializers)
                            e.logger?.log(lt.Warning, `Initializer '${r}' will be ignored because multiple runtimes are available. Use 'before(Web|WebAssembly|Server)Start' and 'after(Web|WebAssembly|Server)Started' instead.`);
                        else if (p)
                            return s(e, i, a, n);
                        if (function(e) {
    ...
    const gt = {
            ...
            return async function(e, t) {
                const {dotnet: n} = await async function(e) {
                    ...
                    if (e.loadBootResource) {
                        const t = "dotnetjs"
                          , n = e.loadBootResource(t, "dotnet.8u19e8ep7x.js", "_framework/dotnet.8u19e8ep7x.js", "", "js-module-dotnet");
                        if ("string" == typeof n) {
                    ...
                    return await import("./dotnet.8u19e8ep7x.js")
                }(e)
                  , r = function(e, t) {
                    const n = {
                    ...
                    const r = {
                        ...
                        onConfigLoaded: async n => {
                            ...
                            et._internal.getApplicationEnvironment = () => n.applicationEnvironment,
                            t?.(n),
                            ht = await async function(e, t) {
                                if (e.initializers)
                                    return await Promise.all(e.initializers.beforeStart.map((t => t(e)))),
                                    new ut(!1,void 0,e.initializers.afterStarted,ct.WebAssembly);
                                {
        ...
        start: function() {
            return async function() {
                ...
                const {setModuleImports: t, INTERNAL: n, getConfig: r, invokeLibraryInitializers: o} = mt;
                ft = n,
                function(e) {
                    const t = ot.match(/^Mac/i) ? "Cmd" : "Alt";
                    it(e) && console.info(`Debugging hotkey: Shift+${t}+D (when application has focus)`),
                    document.addEventListener("keydown", (t => {
                        t.shiftKey && (t.metaKey || t.altKey) && "KeyD" === t.code && (it(e) ? navigator.userAgent.includes("Firefox") ? async function() {
                ...
                t("blazor-internal", {
                    Blazor: {
                        _internal: et._internal
                    }
                });
                const i = await mt.getAssemblyExports("Microsoft.AspNetCore.Components.WebAssembly");
                return Object.assign(et._internal, {
                    dotNetExports: {
                ...
                dt = e.attachDispatcher({
                    beginInvokeDotNetFromJS: (e, t, n, r, o) => {
                        ...
                        et._internal.dotNetExports.BeginInvokeDotNet(e ? e.toString() : null, i, n, o)
                    }
                    ,
    ...
    class St {
        ...
        release() {
            ...
            for (ft.mono_wasm_gc_unlock(),
            pt = null; this.postReleaseActions?.length; )
                this.postReleaseActions.shift()(),
                Et()
        }
        static create() {
            return ft.mono_wasm_gc_lock(),
            new St
        }
    }
    class Ct {
    ...
    const _t = /^\s*Blazor-WebAssembly-Component-State:(?<state>[a-zA-Z0-9+/=]+)$/
    ...
    function Yt(e, t) {
        ...
        return Bt = new Promise(qt.bind(null, e, t)),
        Bt
    }
    async function qt(e, n, r, o) {
        ...
        ,
        et._internal.navigationManager.listenForNavigationEvents(ct.WebAssembly, (async (e, t, n) => {
            await dt.invokeDotNetStaticMethodAsync("Microsoft.AspNetCore.Components.WebAssembly", "NotifyLocationChanged", e, t, n)
        }
        ), (async (e, t, n, r) => {
            const o = await dt.invokeDotNetStaticMethodAsync("Microsoft.AspNetCore.Components.WebAssembly", "NotifyLocationChangingAsync", t, n, r);
        ...
        ,
        et._internal.endUpdateRootComponents = t => e.onAfterUpdateRootComponents?.(t),
        et._internal.attachRootComponentToElement = (e, t, n) => {
            const r = a.resolveRegisteredElement(e);
            r ? we(n, r, t, !1) : function(e, t, n) {
                const r = "::before";
                let o = !1;
                if (e.endsWith("::after"))
                    e = e.slice(0, -7),
        ...
        s.callEntryPoint(),
        ht.invokeAfterStartedCallbacks(et),
        r()
    }
    function Zt(e) {
        return Pt ??= (async () => {
    ...
    function Qt(e, t, n, r, o, i) {
        return 0 !== o ? (dt.beginInvokeJSFromDotNet(o, e, r, n, t, i),
        null) : dt.invokeJSFromDotNet(e, r, n, t, i)
    }
    function en(e, t, n) {
    ...
    function tn(e, t, n, r) {
        !function(e, t, n, r, o) {
            ...
            o ? (i.error(o),
            Qe.delete(t)) : 0 === r ? (i.close(),
            Qe.delete(t)) : i.enqueue(n.length === r ? n : n.subarray(0, r))
        }(dt, e, t, n, r)
    }
    function nn(e, t) {
    ...
    et.start = an,
    window.DotNet = e,
    document && document.currentScript && "false" !== document.currentScript.getAttribute("autostart") && an().catch(wt)
}();
